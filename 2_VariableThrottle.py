...
# convert image into grayscale and stack 4 frames
img_channels = 4
# throttle value in an array to match steering angle
...
class DQNAgent:
    ...
    def get_action(self, s_t):
        if np.random.rand() <= self.epsilon:
            ...
            # choose a random array index for steering and throttle
            global steering_index
